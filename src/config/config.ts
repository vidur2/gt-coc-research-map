...
const layout = {
  ...
  defaultPointColorInt: [0, 0, 0, 0],
  secondPointColorInt: [212, 20, 207],
  timePointColorInt: [0, 0, 0, 0],
  contourLevels: 12,
  searchLimit: 5000,
  groupColors: [colors['blue-500'], colors['red-600']]
};
...
export const config = {
  ...
  gridColorLight: 'hsla(240, 68%, 5%, 1.00)',
