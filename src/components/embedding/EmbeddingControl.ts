...
export function drawContourTimeSlice(this: Embedding) {
  if (this.gridData == null) {
    console.warn('drawContourTimeSlice: Grid data not initialized');
    return;
  }

  if (this.gridData.timeGrids === undefined) {
    console.warn('drawContourTimeSlice: No time info available');
    return;
  }

  if (!this.timeInspectMode || this.curTime === null) {
    console.warn('drawContourTimeSlice: Not in timeInspectMode');
    return;
  }
